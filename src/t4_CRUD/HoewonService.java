...
//		HoewonDAO dao = new HoewonDAO();
	...
	public void getSearch(String name) { 
		...
		else System.out.println("검색된 자료가 존재하지 않습니다.");
	...
	public void setUpdate(String name) {
		...
		if(vo.getName() != null) {
			...
			if(choice == 3) vo.setGender(content);
			if(choice == 4) vo.setAddress(content);
			
//			dao.setUpdate(vo.getIdx(), choice, content); 
			int res = dao.setUpdate(vo); 	// res를 받는게 좋음. 수정이 되지 않았을 경우 그것을 표시하기 위해!
	...
	public void setDelete(String name) {
		...
		if(vo.getName() != null) {
			...
			else System.out.println("Y/N 중 입력하세요");
		}
		else System.out.println("검색된 자료가 존재하지 않습니다."); 
