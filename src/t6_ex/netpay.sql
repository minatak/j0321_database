...
create table insa (
	...
	sabun  char(8) not null,				/* 직급코드(년(2자리) 월(2) 일(2) 일련번호(2) - 중복 불가*/
...
insert into insa values (default, '24032201', '총무과', '이기자', '사원', 25, '2022-1-5', '남자', '서울');
...
--이기자의 본봉?
select * from salary s, insa i where s.jikkub = i.jikkub; /* 두 테이블을 join 시킨것 !*/ 
