...
alter table sinsang change column adress address varchar(50);
...
update sinsang set point = 0 where ipsail < '1990-1-1';
...
select * from sinsang where age >= 30 and age <= 39;
...
select mid as '아이디',name as '이름',gender as '성별' from sinsang order by idx limit 5,5;
